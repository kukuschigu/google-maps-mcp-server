export class GoogleMapsClient {
    ...
    formatPlaceResult(place) {
        ...
        if (place.currentOpeningHours)
            result.opening_hours = place.currentOpeningHours;
        ...
        if (place.editorialSummary)
            result.editorial_summary = place.editorialSummary;
        if (place.websiteUri)
            result.website = place.websiteUri;
        if (place.nationalPhoneNumber)
            result.phone_number = place.nationalPhoneNumber;
        if (place.internationalPhoneNumber)
            result.international_phone_number = place.internationalPhoneNumber;
        if (place.priceLevel)
