...
export class GoogleMapsClient {
   ...
   */
  private transformPlacesFields(fields: string[], addPrefix: boolean = true): string {
  ...
  private formatPlaceResult(place: any): PlaceResult {
    ...
    if (place.formattedAddress) result.formatted_address = place.formattedAddress;

    // Include addressComponents from new Places API
    if (place.addressComponents) result.address_components = place.addressComponents;
